...
class NGMedalPopUp extends FlxTypedSpriteGroup<FlxSprite>
{
	...
	public function new(MedalName:String, MedalURL:String = "")
	{
		...
		medal_name = Utils.formatText(medal_name, "center", FlxColor.WHITE, true, "assets/fonts/Verdana.ttf", 22);

		points_text = new FlxText(171 + 21, 9, 50, "");
		points_text = Utils.formatText(points_text, "center", FlxColor.WHITE, true, "assets/fonts/Verdana.ttf", 12);
