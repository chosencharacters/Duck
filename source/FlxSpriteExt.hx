...
class FlxSpriteExt extends FlxSprite
{
	 ...
	 */
	public function animAdd(animName:String, animString:String, ?fps:Int = 10, loopSet:Bool = true, flipXSet:Bool = false, flipYSet:Bool = false,
	 ...
	 */
	public function animAddPlay(animName:String, animString:String, fps:Int = 10, loopSet:Bool = true, flipXSet:Bool = false, flipYSet:Bool = false,
			animationLink:String = "")
	{
		animation.add(animName, Utils.anim(animString), fps, loopSet, flipXSet, flipYSet);
